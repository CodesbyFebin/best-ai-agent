import { generateDynamicPillarContent, isTopicalAuthoritySlug } from './topicalAuthority';
...
// Find page by slug (works for both static and dynamic pages)
export const getPageBySlug = (slug: string): SiloPage | undefined => {
