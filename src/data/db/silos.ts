...
export const silos: Silo[] = [
  ...
  { id: 'editorial', name: 'Editorial', purpose: 'Methodology, review policy, editorial independence, and evaluation criteria.', pillarTitle: 'Editorial Methodology', pillarSlug: 'methodology', description: 'Scoring framework, testing protocols, update cadence, and editorial independence standards.', color: 'slate', icon: 'FileText' },
];
